...
const StudentPayments = () => {
  ...
  const uiStats = {
    totalPaid: `Rs. ${Number(stats.total_paid || 0).toLocaleString()}`,
    pending: `Rs. ${Number(stats.pending_amount || 0).toLocaleString()}`,
        ...
        <DataTable
          ...
          columns={[
            ...
            },
            {
              key: 'total',
              label: 'Amount',
              render: (value) => <p className="text-sm font-medium text-gray-900">Rs. {Number(value || 0).toLocaleString()}</p>,
            },
            {
              key: 'created_at',
              label: 'Date',
              render: (value) => <p className="text-sm text-gray-600">{value ? new Date(value).toLocaleDateString() : '-'}</p>,
            },
            {
              key: 'status',
              label: 'Status',
                ...
                <ButtonWithLoader
                  ...
                  onClick={() => {
                    ...
                    setTimeout(() => {
                      ...
                      showNotification('Invoice download will be enabled soon', 'info');
                    }, 700);
                  }}
                  variant="primary"
                  size="sm"
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm mb-3">
                      ...
                      <div>
                        ...
                        <div className="font-bold text-yellow-700 text-lg">
                          Rs. {Number(payment.total || 0).toLocaleString()}
                        </div>
                      </div>
                      <div>
